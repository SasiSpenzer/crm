<!-- Modal start-->
<div class="modal fade" id="membershipModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" id="membershipModalContent">
            <div class="modal-header">
                <button type="button" class="close" aria-label="Close" onclick="closeMembershipModal()"><span aria-hidden="true">&times;</span></button>
