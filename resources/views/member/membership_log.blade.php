<div class="modal fade" id="membershipLogModal" tabindex="-1" role="dialog" aria-labelledby="logModalLabel"
     data-backdrop="static" data-keyboard="false" style="overflow-y: hidden !important;">
                ...
                <form role="form" id="log_form">
                    <div class="form-group">
                        <select class="form-control" id="membership_status">
                            ...
                            <?php
                            $status = \App\PaymentStatus::select('payment_status_id', 'payment_status')->whereIn('is_enable', [1])
