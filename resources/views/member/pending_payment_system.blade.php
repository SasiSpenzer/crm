		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
			                    <ul class="nav nav-pills" style="margin-bottom: 5px;">
									...
									<li>
										<a id="btn-mycon" href="#mycontacts" data-toggle="tab">My Contacts</a>
									</li>
			                        <li>
			                            <a id="btn-followups" href="#followups" data-toggle="tab">Follow-Ups</a>
			                        </li>
{{--			                        <li>--}}
{{--			                            <a id="btn-two-left" href="#twoleft" data-toggle="tab">Order List By Date</a>--}}
{{--			                        </li>--}}
...
{{--						@include('member.details_modal_uncontacted')--}}
					...
					<div class="tab-pane fade" id="mycontacts">
						<div class="alert" id="flash_message" style="display:none"></div>
...
<script type="text/javascript" src="{{ URL::asset('/js/app/member/pending-payment-system-all.js') }}"></script>
@endsection