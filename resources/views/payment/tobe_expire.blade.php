		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<ul class="nav nav-pills">
					...
					<li><a id="btn-month" href="#one-month-before" data-toggle="tab">In One Month</a>
					</li>
				</ul>
				<!-- Tab panes -->
...
<!-- /.row -->
<script type="text/javascript" src="{{ URL::asset('/js/app/payment/tobe-expire.js') }}"></script>
@endsection