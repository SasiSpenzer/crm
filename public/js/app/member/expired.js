$(document).ready(function() {
    ...
    var user_member_details_table = $('#tbl-all').DataTable({
        ...
        ajax: url + "/member/expire/expired/all",
        columns: [{
            data: null,
            width: "20%",
    ...
    $('#btn-yesterday').click(function(){
        if(!btn_week_clicked){
            $('#tbl-today').DataTable({
                ...
                "lengthMenu": [50, 100],
                pagingType: "simple_numbers",
                ajax: url + "/member/expire/expired/yesterday",
                columns: [{
                    data: null,
                    width: "20%",
                    render: function(data, type, row) {
    ...
    $('#btn-week').click(function(){
        ...
        if (!btn_week_clicked){
            ...
            $('#tbl-week').DataTable({
                ...
                "lengthMenu": [50, 100],
                pagingType: "simple_numbers",
                ajax: url + "/member/expire/expired/after-one-week",
                columns: [{
                    data: null,
                    width: "20%",
                    render: function(data, type, row) {
    ...
    $('#btn-month').click(function(){
        ...
        if (!btn_month_clicked){
            ...
            $('#tbl-month').DataTable({
                ...
                "lengthMenu": [50, 100],
                pagingType: "simple_numbers",
                ajax: url + "/member/expire/expired/after-one-month",
                columns: [{
                    data: null,
                    width: "20%",
                    render: function(data, type, row) {
