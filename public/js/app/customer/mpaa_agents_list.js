$(document).ready(function() {
    ...
    $('#add_date_range').click(function() {
        ...
        if(start_date == null || start_date == '') {
            ...
            let search_data_table = $('#search-data-tbl').DataTable({
                ...
                "ajax": {
                    "url": url + "/member/mpaa/agent/search/data",
                    data: {
    ...
    let customer_details_table = $('#paa-agents-table').DataTable({
        ...
        "pageLength": 300,
        pagingType: "simple_numbers",
        ajax: url + "/member/mpaa/agents/data",
        columns: [{
            data: 'username',
            name: 'username',
            "searchable": true,
            ...
            render: function(data, type, row) {
                if(data.ads_count == "0"){
                   //return '<a type="button" disabled readonly class="btn btn-warning btn-ppa-view" href="'+url+'/member/mpaa/agent/'+data.uid+'">View</a>'
                   return '<a type="button" disabled readonly class="btn btn-warning btn-ppa-view" href="#">View</a>'
                } else {
                    return '<a type="button" class="btn btn-warning btn-ppa-view" href="'+url+'/member/mpaa/agent/'+data.uid+'">View</a>'
                    //return '<a type="button" class="btn btn-warning btn-ppa-view" href="#">View</a>'
                }
